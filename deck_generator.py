...
# Carte 1 :
tank = {"name":"Tank","atk":1,"vie":1,"cout":1,"path":"placeholder","qte":4, "taunt":False}
# Carte 2 :
panda_roux = {"name":"Panda roux","atk":1,"vie":2,"cout":2,"path":"placeholder",
              "qte":3,"taunt":False}
# Carte 3 :
canard_en_plastique = {"name":"Canard en \
plastique","atk":3,"vie":2,"cout":3,"path":"placeholder","qte":1, "taunt":True}
# Carte 4 :
palpatine = {"name":"Palpatine","atk":4,"vie":2,"cout":4,
             "path":"placeholder","qte":1, "taunt":False}
# Carte 5 :
...
patchouli = {"name":"Patchouli","atk":2,"vie":1,"cout":1,
             "path":"./patchouli.gif","qte":3,"taunt":False}
# Carte 8 :
moussa = {"name":"Moussa","atk":2,"vie":3,"cout":3,
          "path":"placeholder","qte":1,"taunt":True}
# Carte 9 :
projecteur = {"name":"Projecteur Epson","atk":1,"vie":1,"cout":10,
              "path":"placeholder","qte":1,"taunt":True}
# Carte 10 :
quenouille = {"name":"Quenouille","atk":2,"vie":2,"cout":2,
              "path":"placeholder","qte":2,"taunt":False}
# Carte 11 :
